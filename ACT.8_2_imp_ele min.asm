...
_start:
    ...
    mov eax, 10       
    mov ebx, 3      
    add eax, ebx      ;Se suman 5 al 10 almacenado en eax

    ; Instrucción lógica (AND)
    and eax, 0xF      

    ; Instrucciones de manipulación de bits
    shl eax, 2       ;desplaza hacia la izquierda el 15 en binario convirtiéndolo en un 30 binario: de 1111 a 11110
    ...
    add eax, '8'      ; Convertir el número en carácter (ASCII)
